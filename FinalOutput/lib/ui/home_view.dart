      ...
      child: Transform(
        ...
        child: Container(
          ...
          child: Icon(
            ...
            color: model.index % 2 == 0 ? Global.white : Global.deepPurple,
          ),
        ),
      ),
    );
...
class _HomeViewState extends State<HomeView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor:
            model.isHalfWay ? model.backGroundColor : model.foreGroundColor,
              ...
              itemBuilder: (context, index) {
                return Center(
                  child: Text(
                    'Page ${index + 1}',
                    style: TextStyle(
                      color: index % 2 == 0 ? Global.deepPurple : Global.white,
                      fontSize: 30.0,
